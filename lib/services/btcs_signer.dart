...
class BTCSSigner {
  ...
  static Uint8List _normalizeToDer(Uint8List signature) {
    // Some runtimes return compact 64-byte signatures (r||s), others return DER.
    ...
    throw Exception('Unexpected signature format (length=${signature.length}).');
  }
  ...
  static Uint8List _scriptCodeFromUtxoScript(Uint8List scriptPubKey) {
    // Native SegWit P2WPKH scriptPubKey: 0x00 0x14 <20-byte-hash>
    ...
    // Legacy P2PKH scriptPubKey: OP_DUP OP_HASH160 PUSH20 <20-byte-hash> OP_EQUALVERIFY OP_CHECKSIG
